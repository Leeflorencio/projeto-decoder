...
public class SpecificationTemplate {
    ...
    public interface CourseSpec extends Specification<CourseModel> {} //curso

    @Spec(path = "title", spec = Like.class)
    public interface ModuleSpec extends Specification<ModuleModel> {} //modulo

    @Spec(path = "title", spec = Like.class)
    public interface LessonSpec extends Specification<LessonModel> {} //lições
